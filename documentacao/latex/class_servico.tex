...
\begin{DoxyCompactList}\small\item\em Função para obter o número de empregados na empresa de serviços. \end{DoxyCompactList}\item 
...
Função para obter o número de empregados na empresa de serviços. 

\begin{DoxyReturn}{Returns}
Retorna o número de empregados na empresa de serviços. 
\end{DoxyReturn}
