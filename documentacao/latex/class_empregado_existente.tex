...
\begin{DoxyCompactList}\small\item\em Cria exceção para quando se tenta adicionar um empregado que já existe. \end{DoxyCompactList}\item 
...
Cria exceção para quando se tenta adicionar um empregado que já existe. 
