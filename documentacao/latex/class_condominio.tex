...
\end{DoxyReturn}
\index{Condominio@{Condominio}!procura\+Habitacao@{procura\+Habitacao}}
\index{procura\+Habitacao@{procura\+Habitacao}!Condominio@{Condominio}}
\subsubsection[{procura\+Habitacao(\+Habitacao $\ast$habitacao)}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ {\bf Habitacao} $\ast$ $>$\+::iterator Condominio\+::procura\+Habitacao (
\begin{DoxyParamCaption}
\item[{{\bf Habitacao} $\ast$}]{habitacao}
\end{DoxyParamCaption}
)}\hypertarget{class_condominio_a19d0973b7485841e6b1be8a242367e9c}{}\label{class_condominio_a19d0973b7485841e6b1be8a242367e9c}


Procura uma dada habitação. 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Retorna o iterador para a posição da habitação procurada no vector de habitações do cliente. 
\end{DoxyReturn}
