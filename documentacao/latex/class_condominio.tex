...
\subsubsection[{adiciona\+Cliente(\+Cliente $\ast$cliente)}]{\setlength{\rightskip}{0pt plus 5cm}void Condominio\+::adiciona\+Cliente (
\begin{DoxyParamCaption}
\item[{{\bf Cliente} $\ast$}]{cliente}
\end{DoxyParamCaption}
)}\hypertarget{class_condominio_a423f977875d9b8b5fdc5af2d9cd9dbf2}{}\label{class_condominio_a423f977875d9b8b5fdc5af2d9cd9dbf2}
