...
\begin{itemize}
	...
	\item Regista e guarda habitações, condomínios, empregados e serviços;
	\item Manutenção de condomínios;
	\item Manutenção de habitações e respesctivos preços de condomínio;
